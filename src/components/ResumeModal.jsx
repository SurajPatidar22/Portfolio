          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 24px', borderBottom: '1px solid rgba(255,255,255,0.1)', backgroundColor: '#0f172a' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <a
                  href="/resume.png?v=2"
                  download="Suraj_Patidar_Resume.png"
                  style={{ 
                    display: 'flex', 
                    alignItems: 'center', 
                    gap: '8px', 
            ...
            {/* Body */}
            <div style={{ flex: 1, overflowY: 'auto', padding: '24px', display: 'flex', justifyContent: 'center', backgroundColor: '#e2e8f0' }}>
              <img 
                src="/resume.png?v=2" 
                alt="Suraj Patidar Resume" 
                style={{ 
                  maxWidth: '100%', 
                  height: 'auto', 
                  borderRadius: '4px', 
                ...
                onError={(e) => {
                  ...
                  e.target.src = "https://via.placeholder.com/800x1131/ffffff/333333?text=Resume+Placeholder";
                }}
              />
            </div>
          </motion.div>
